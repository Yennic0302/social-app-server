...
export const getFriendRequestRecieve = async (req, res, next) => {
  try {
    let idFriendRequestRecieve = req.params.id;

    const friendRequest = await User.findOne({
      _id: idFriendRequestRecieve,
